...
function Projects() {
  let projects = [ 
    {name: 'Alternate Portfolio', description: 'A portfolio website that display my skills and projects, with a more colorful theme than my default portfolio website', technologies: 'JavaScript, Node, React, React-MDL', imageUrl:"./AlternatePortfolio.png", imageAlt: 'Photo of Alternate Portfolio website', link: 'https://github.com/nataliegarate/alternate_portfolio'},
    ...
    {name: 'Best Cupcakes', description:'An E-Commerce that sells delicious cupcakes. It has a store inventory, shopping cart, and checkout feature.', technologies: 'JavaScript, Node, React, Redux, Express, and Sequelize with PostgreSQL', imageUrl:"./BestCupcakes.png", imageAlt: 'photo of cupcake website', link: 'http://cupcake-shop-app.herokuapp.com/'},

...
function Projects() {
  let projects = [ 
    {id: 'gratitude', name: 'Gratitude Master', description: 'An  online journal space that encourages users to track what makes them happy. Users can create, delete, and update their entries which are stored in the database.', technologies: 'JavaScript, Node, React, Redux, Express, and Sequelize with PostgreSQL', imageUrl:"./GratitudeMaster.png", imageAlt: 'Photo of Gratitude Master website', link: 'https://github.com/nataliegarate/gratitude-tracker'},
